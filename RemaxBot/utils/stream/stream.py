...
import config
from RemaxBot import Carbon, YouTube, app
...
from RemaxBot.utils.exceptions import AssistantErr
from RemaxBot.utils.inline.play import (stream_markup,
                                          telegram_markup)
from RemaxBot.utils.inline.playlist import close_markup
from RemaxBot.utils.pastebin import Remaxbin
from RemaxBot.utils.stream.queue import put_queue, put_queue_index
...
async def stream(
    ...
    if forceplay:
        await Remax.force_stop_stream(chat_id)
