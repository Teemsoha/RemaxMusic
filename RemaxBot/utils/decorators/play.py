...
from RemaxBot.utils.database import (get_cmode, get_lang,
                                       get_playmode, get_playtype,
                                       is_active_chat,
                                       is_commanddelete_on,
                                       is_served_private_chat)
from RemaxBot.utils.database.memorydatabase import is_maintenance
        ...
        if PRIVATE_BOT_MODE == str(True):
            if not await is_served_private_chat(message.chat.id):
                await message.reply_text(
                    "**روبوت الموسيقى الخاص**\n\nفقط للمحادثات المصرح بها من المالك. اطلب من مالكي السماح بالدردشة أولاً."
                )
