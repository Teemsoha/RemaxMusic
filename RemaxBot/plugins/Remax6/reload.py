...
from RemaxBot.utils.database import get_authuser_names, get_cmode
from RemaxBot.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from RemaxBot.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Remax.stop_stream(message.chat.id)
    except:
        pass
