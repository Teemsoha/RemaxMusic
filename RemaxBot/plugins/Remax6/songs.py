...
from RemaxBot.utils.formatters import convert_bytes
from RemaxBot.utils.inline.song import song_markup
...
async def song_helper_cb(client, CallbackQuery, _):
    ...
    if stype == "audio":
        ...
        try:
            ...
            return await CallbackQuery.edit_message_text(_["song_7"])
        keyboard = InlineKeyboard()
        # AVC Formats Only [ Remax MUSIC BOT ]
