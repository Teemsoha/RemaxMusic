...
from RemaxBot import (Apple, Resso, SoundCloud, Spotify, Telegram,
                        YouTube, app)
from RemaxBot.core.call import Remax
from RemaxBot.utils import seconds_to_min, time_to_seconds
from RemaxBot.utils.channelplay import get_channeplayCB
from RemaxBot.utils.database import is_video_allowed
from RemaxBot.utils.decorators.language import languageCB
from RemaxBot.utils.decorators.play import PlayWrapper
from RemaxBot.utils.formatters import formats
from RemaxBot.utils.inline.play import (livestream_markup,
                                          playlist_markup,
                                          slider_markup, track_markup)
from RemaxBot.utils.inline.playlist import botplaylist_markup
from RemaxBot.utils.logger import play_logs
from RemaxBot.utils.stream.stream import stream
...
@app.on_message(
    filters.command(["/play","شغل","تشغيل","دينا شغلي"],"")
    & filters.group
    & ~BANNED_USERS
)
@PlayWrapper
...
@app.on_callback_query(
    filters.regex("RemaxPlaylists") & ~BANNED_USERS
)
@languageCB
